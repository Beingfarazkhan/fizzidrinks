...
const Scene = (props: Props) => {
    ...
    useGSAP(() => {
        ...
        // Setting the initial position of the cans
        ...
        // Animation Should Only Run if the User is at the top of the page
        ...
        scrollTl
            // Rotate Can Group
            .to(groupRef.current.rotation, { y: 2 * Math.PI, }, 0)
            ...
            .to(groupRef.current.position, { x: 1, duration: 3, ease: "sine.inOut" }, 1.4)
    })
